...
class SwapFacePipelineOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoint_path', default='/home/sb1/sanoojan/e4s/running_exp_FFHQ/checkpoints/iteration_200000.pt', type=str, help='Path to E4S pre-trained model checkpoint')
